                                ...
                                <div class="media-box-bottom">
                                    ...
                                    <div class="right">
                                        ...
                                        <div class="fixed-action-btn right">
                                            ...
                                            <ul>
                                                <li><a href="https://vkontakte.ru/share.php?url={{route('article',['alias'=>$article->alias, 'category'=>$article->cat->alias])}}" class="btn-floating color_vk_btn" target="_blank" rel="nofollow"><i class="fa fa-vk"></i></a></li>
                                                <li><a onclick="postFB('{{route('article',['alias'=>$article->alias, 'category'=>$article->cat->alias])}}')" id="shareFB_list_{{$article->id}}" class="btn-floating color_facebook_btn" rel="nofollow"><i class="fa fa-facebook"></i></a></li>

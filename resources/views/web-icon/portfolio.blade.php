...
<div class="content_page">
    ...
    <div class="main animate" style="padding-bottom: 0;">
        {{--<h1 class="title_page no-pod_title_text text-center">{{(LaravelLocalization::getCurrentLocale() == 'ru') ? $portfolio->name : $portfolio->name_en}}</h1>--}}

        <div style="margin-right: -22px;">
            <a class="portfolio_case_link" href="{{route('portfolios')}}" style="">{{--<i class="fa fa-angle-up"></i>--}}</a>
            <iframe src="{{$portfolio->iframe_link}}" style="width: 100%; height: 100%;" scrolling="auto">
                {{trans('main.no_iframe')}}
            </iframe>
        </div>
        ...
        {{--<div class="container container_content color_white box_radius box_shadow">
            <div class="content_page_box">
                <div class="row">
                    <div class="col s12">
                        {!!(LaravelLocalization::getCurrentLocale() == 'ru') ? $portfolio->short_desc : $portfolio->short_desc_en!!}
                    </div>
                </div>
                <div class="row">
                    <div class="col s12">
                        {!!(LaravelLocalization::getCurrentLocale() == 'ru') ? $portfolio->desc : $portfolio->desc_en!!}
                    </div>
                </div>
            </div>
        </div>--}}
